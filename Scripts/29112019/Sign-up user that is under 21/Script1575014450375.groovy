...
Mobile.tap(findTestObject('Sign-up user that is under 21/android.widget.CheckedTextView0 - 2010'), 0)

Mobile.tap(findTestObject('Sign-up user that is under 21/android.widget.Button0 - CREATE MY ACCOUNT'), 0)

Mobile.verifyMatch('You must be 18 years of age or older to use dutchie', 'You must be 18 years of age or older to use dutchie', 
    false)
