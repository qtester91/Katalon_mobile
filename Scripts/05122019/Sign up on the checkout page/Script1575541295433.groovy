...
Mobile.tap(findTestObject('Colorado sunshine/android.widget.Spinner0 - Specials'), 0)

Mobile.tap(findTestObject('Colorado sunshine/android.widget.CheckedTextView0 - Pre-Rolls'), 0)

Mobile.delay(2)

Mobile.scrollToText('Colorado Sunshine', FailureHandling.STOP_ON_FAILURE)
